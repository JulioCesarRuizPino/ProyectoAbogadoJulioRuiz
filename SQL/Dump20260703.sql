...
CREATE TABLE `abogado_especialidad` (
  `abogado_id` int NOT NULL,
  `especialidad_id` int NOT NULL,
  PRIMARY KEY (`abogado_id`,`especialidad_id`),
  KEY `fk_abogado_especialidad_especialidad` (`especialidad_id`),
  CONSTRAINT `fk_abogado_especialidad_abogado` FOREIGN KEY (`abogado_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_abogado_especialidad_especialidad` FOREIGN KEY (`especialidad_id`) REFERENCES `especialidades` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `especialidades` (`id`,`nombre`) VALUES
(1,'familia'),(2,'laboral'),(3,'civil'),(4,'penal'),(5,'comercial'),(6,'inmobiliario'),(7,'migratorio');
INSERT INTO `abogado_especialidad` (`abogado_id`,`especialidad_id`) VALUES
